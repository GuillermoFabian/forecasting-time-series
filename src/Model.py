...
learning_rate = float(configfile.get('model', 'learning_rate'))
widths = int(configfile.get('model', 'widths'))

optimization_trials = int(configfile.get('optimization', 'optimization_trials'))
num_blocks_param = int(configfile.get('optimization', 'num_blocks_param'))
num_block_layers_param = int(configfile.get('optimization', 'num_block_layers_param'))
expansion_coefficient_lengths_T_param = int(configfile.get('optimization', 'expansion_coefficient_lengths_T_param'))
expansion_coefficient_lengths_S_param = int(configfile.get('optimization', 'expansion_coefficient_lengths_S_param'))
